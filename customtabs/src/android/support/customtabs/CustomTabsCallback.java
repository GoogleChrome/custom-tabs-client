...
public class CustomTabsCallback {
    ...
    public static class Wrapper extends ICustomTabsCallback.Stub {
        ...
        void attachToService(Context context, ComponentName componentName) {
            mApplicationContext = context;
            mServiceComponentName = componentName;
        }

        Wrapper(CustomTabsCallback callback, Context context,
        ...
        Wrapper(CustomTabsCallback callback) {
            this(callback, null, null);
        }

        @Override
        public void onNavigationEvent(final int navigationEvent, final Bundle extras) throws RemoteException {
        ...
        public void onRelationshipValidationResult(final int relation, final Uri requestedOrigin,
                                                   final boolean result, final Bundle extras) throws RemoteException {

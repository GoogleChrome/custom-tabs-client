 ...
 */
public class BrowserActionsDefaultMenuAdapter extends BaseAdapter {
    private final List<BrowserActionItem> mMenuItems;
    private final Context mContext;

    public BrowserActionsDefaultMenuAdapter(List<BrowserActionItem> menuItems, Context context) {

...
public class TrustedWebActivityServiceConnectionManager {
    ...
    /**
     * We use this Object as a lock for setting |sSharedPreferences| in a thread safe way using
     * double-check locking [1]. Usually to make static, thread-safe singletons in Java we'd use the
     * initialization-on-demand holder idiom [2] which it a bit nicer. However, to create

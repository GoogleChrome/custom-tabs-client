...
public class TrustedWebActivityServiceWrapper {
    ...
    // Outputs.
    static final String KEY_CONNECTION_SUCCESS =
            "android.support.customtabs.browserservices.CONNECTION_SUCCESS";
    static final String KEY_NOTIFICATION_SUCCESS =
            "android.support.customtabs.browserservices.NOTIFICATION_SUCCESS";
    static final String KEY_SMALL_ICON_ID =
            "android.support.customtabs.browserservices.SMALL_ICON_ID";
    ...
    public boolean notify(String platformTag, int platformId, Notification notification,
        ...
        Bundle args = new NotifyNotificationArgs(platformTag, platformId, notification, channel)
                .toBundle();
        NotifyNotificationResultArgs result = NotifyNotificationResultArgs.fromBundle(mService.notifyNotificationWithChannel(args));
        return result.mNotificationSuccess;
    }
    ...
    public void cancel(String platformTag, int platformId) throws RemoteException {
        ...
        ResultArgs result = mService.cancelNotification(args);
    }

    public int getSmallIcon() throws RemoteException {
        GetSmallIconIdResultArgs result =
                GetSmallIconIdResultArgs.fromBundle(mService.getSmallIconId());

        if (result.mConnectionSuccess) {
            return result.mSmallIconId;
        }
        return -1;
    }
    ...
    static class ResultArgs {
        public final boolean mConnectionSuccess;

        public ResultArgs(boolean connectionSuccess) {
            mConnectionSuccess = connectionSuccess;
        }

        public static ResultArgs fromBundle(Bundle bundle) {
            ensureBundleContains(bundle, KEY_CONNECTION_SUCCESS);
            return new ResultArgs(bundle.getBoolean(KEY_CONNECTION_SUCCESS));
        }

        public Bundle toBundle() {
            Bundle args = new Bundle();
            args.putBoolean(KEY_CONNECTION_SUCCESS, mConnectionSuccess);
            return args;
        }
    }

    static class GetSmallIconIdResultArgs extends ResultArgs {
        public final int mSmallIconId;

        public GetSmallIconIdResultArgs(boolean connectionSuccess, int smallIconId) {
            super(connectionSuccess);
            mSmallIconId = smallIconId;
        }

        public static GetSmallIconIdResultArgs fromBundle(Bundle bundle) {
            ensureBundleContains(bundle, KEY_CONNECTION_SUCCESS);
            ensureBundleContains(bundle, KEY_SMALL_ICON_ID);
            return new GetSmallIconIdResultArgs(bundle.getBoolean(KEY_CONNECTION_SUCCESS),
                    bundle.getInt(KEY_SMALL_ICON_ID));
        }

        @Override
        public Bundle toBundle() {
            Bundle args = super.toBundle();
            args.putInt(KEY_SMALL_ICON_ID, mSmallIconId);
            return args;
        }
    }

    static class NotifyNotificationResultArgs extends ResultArgs {
        public final boolean mNotificationSuccess;

        public NotifyNotificationResultArgs(boolean connectionSuccess,
                boolean notificationSuccess) {
            super(connectionSuccess);
            mNotificationSuccess = notificationSuccess;
        }

        public static NotifyNotificationResultArgs fromBundle(Bundle bundle) {
            ensureBundleContains(bundle, KEY_CONNECTION_SUCCESS);
            ensureBundleContains(bundle, KEY_NOTIFICATION_SUCCESS);
            return new NotifyNotificationResultArgs(bundle.getBoolean(KEY_CONNECTION_SUCCESS),
                    bundle.getBoolean(KEY_NOTIFICATION_SUCCESS));
        }

        @Override
        public Bundle toBundle() {
            Bundle args = super.toBundle();
            args.putBoolean(KEY_NOTIFICATION_SUCCESS, mNotificationSuccess);
            return args;
        }
    }

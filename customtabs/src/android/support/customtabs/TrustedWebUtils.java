...
public class TrustedWebUtils {
    ...
    public static class TrustedWebActivityBuilder {
        ...
        public TrustedWebActivityBuilder setSplashScreen(@Nullable View splashScreenView) {
            ...
            setupSplashScreenView(splashScreenView);
            return this;
        }

        @TargetApi(Build.VERSION_CODES.LOLLIPOP)
        private void setupSplashScreenView(@NonNull View splashScreenView) {
        ...
        public void launchActivity() {
            ...
            if (mSplashScreenView != null) {
                transitionAnimationBundle = makeTransitionAnimationBundle();
        ...
        @TargetApi(Build.VERSION_CODES.LOLLIPOP)
        private Bundle makeTransitionAnimationBundle() {

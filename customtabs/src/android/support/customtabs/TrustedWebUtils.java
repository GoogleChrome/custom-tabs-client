...
public class TrustedWebUtils {
    ...
    public @interface SplashScreenParamKey {
         ...
         */
        String SCALE_TYPE =
                "android.support.customtabs.trusted.KEY_SPLASH_SCREEN_SCALE_TYPE";
        ...
        String IMAGE_TRANSFORMATION_MATRIX =
                "android.support.customtabs.trusted.KEY_SPLASH_SCREEN_TRANSFORMATION_MATRIX";
        ...
        String FADE_OUT_DURATION =
                "android.support.customtabs.trusted.KEY_SPLASH_SCREEN_FADE_OUT_DURATION";
    }

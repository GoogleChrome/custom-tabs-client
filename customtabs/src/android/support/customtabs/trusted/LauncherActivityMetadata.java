...
public class LauncherActivityMetadata {
    ...
    private static final String METADATA_SPLASH_IMAGE_DRAWABLE_ID =
            "android.support.customtabs.trusted.SPLASH_IMAGE_DRAWABLE_ID";
    ...
    private LauncherActivityMetadata() {
        defaultUrl = null;
        statusBarColorId = DEFAULT_COLOR_ID;
        splashScreenBackgroundColorId = DEFAULT_COLOR_ID;
        splashImageDrawableId = 0;
    ...
    private LauncherActivityMetadata(@NonNull Bundle metaData) {
        ...
        splashScreenBackgroundColorId = metaData.getInt(METADATA_SPLASH_SCREEN_BACKGROUND_COLOR, 0);

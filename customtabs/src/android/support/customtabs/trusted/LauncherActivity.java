    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (splashScreenNeeded()) {
            mSplashScreenStrategy = new PwaWrapperSplashScreenStrategy(this,
                    ...
                    ContextCompat.getColor(this, mMetadata.splashScreenBackgroundColorId),
        ...
        mTwaLauncher.openUrl(getLaunchingUrl(),
                ContextCompat.getColor(this, mMetadata.statusBarColorId),

...
public class LauncherActivity extends AppCompatActivity {
    ...
    protected CustomTabsSession getSession(CustomTabsClient client) {
        CustomTabsCallback callback = mShowSplashScreen ? new SplashScreenEventsCallback() : null;
    ...
    private class SplashScreenEventsCallback extends CustomTabsCallback {
        @Override
        public void onTrustedWebActivityEvent(int event, Bundle extras) {
            if (event == TRUSTED_WEB_ACTIVITY_SHOW_SPLASH) {
                showSplashActivity();
            } else if (event == TRUSTED_WEB_ACTIVITY_HIDE_SPLASH) {
                hideSplashActivity();
            }
        }

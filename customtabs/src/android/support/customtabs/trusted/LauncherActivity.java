 ...
 * [5] https://pr-preview.s3.amazonaws.com/ewilligers/web-share-target/pull/53.html
 */
public class LauncherActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addShareDataIfNecessary(twaBuilder);
    ...
    private void addShareDataIfNecessary(TrustedWebActivityIntentBuilder twaBuilder) {
        ...
        boolean launchedWithShareIntent = Intent.ACTION_SEND.equals(action)
                || Intent.ACTION_SEND_MULTIPLE.equals(action);
        if (!launchedWithShareIntent) return;
        ...
        ShareData shareData = new ShareData(intent.getStringExtra(Intent.EXTRA_SUBJECT),
                intent.getStringExtra(Intent.EXTRA_TEXT), uris);
        twaBuilder.setShareParams(mMetadata.shareTarget, shareData);
    }

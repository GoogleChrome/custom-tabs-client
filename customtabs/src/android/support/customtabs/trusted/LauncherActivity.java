...
public class LauncherActivity extends AppCompatActivity {
    ...
    @Nullable private SplashImageSaveTask mSplashImageSaveTask;
     ...
     * splash screen view.
     * @return {@link View} that displays the splash screen (this view will be transferred to the
     * browser in a shared element transition).
     */
    ...
    protected void onDestroy() {
        ...
        if (mSplashImageSaveTask != null) {
            mSplashImageSaveTask.cancel();
        }
    }
    ...
    private class TwaCustomTabsServiceConnection extends CustomTabsServiceConnection {
        ...
        public void onCustomTabsServiceConnected(ComponentName componentName,
            ...
            if (mShouldShowSplashScreen) {
                launchTwaAfterSavingSplashImage(builder);
            } else {
                launchTwa(builder);
            }
        }

        private void launchTwaAfterSavingSplashImage(TrustedWebActivityBuilder builder) {
            mSplashImageSaveTask = new SplashImageSaveTask(LauncherActivity.this,
                    mMetadata.splashImageDrawableId, mMetadata.fileProviderAuthority);

            mSplashImageSaveTask.execute(uri -> onSplashImageSaved(builder, uri));
        }

        private void onSplashImageSaved(TrustedWebActivityBuilder builder,  Uri splashImageUri) {
            ...
            splashScreenParams.putBoolean(TrustedWebUtils.KEY_REUSE_CACHED_SPLASH_IMAGE, true);
            builder.setSplashScreen(splashImageUri, splashScreenParams);
            launchTwa(builder);

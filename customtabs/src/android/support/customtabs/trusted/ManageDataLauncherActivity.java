 ...
 * Activities into web browser's site-settings.
 *
...
public class ManageDataLauncherActivity extends AppCompatActivity {
    ...
    private static final String MANAGE_SPACE_URL_METADATA =
    ...
    protected Uri getUrlForManagingSpace() {
        try {
            ...
            if (info.metaData != null && info.metaData.containsKey(MANAGE_SPACE_URL_METADATA)) {
                Uri uri = Uri.parse(info.metaData.getString(MANAGE_SPACE_URL_METADATA));

...
public class TrustedWebActivityServiceConnectionManager {
    ...
    public interface ExecutionCallback {
         ...
         *                         methods. If the user does not want to catch them, they will be
         *                         caught gracefully by {@link #execute}.
         */
     ...
     *               to.
     * @param callback A {@link ExecutionCallback} that will be run with a connection. Any
     *                 {@link RemoteException} or {@link RuntimeException} exceptions thrown by the
     *                 callback will be swallowed. This is to allow users to deal with exceptions
     *                 thrown by {@link TrustedWebActivityServiceWrapper} if they wish, but to fail
     *                 gracefully if they don't.
     *                 TODO(peconn): Figure out threading guarantees.

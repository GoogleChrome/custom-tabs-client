...
public class TrustedWebActivityServiceConnectionManager {
    ...
    public static abstract class ExecutionCallback {
        /**
         ...
         */
        public abstract void onConnected(@Nullable TrustedWebActivityServiceWrapper service)
                throws RemoteException;

        /**
         * Calls onConnected on a background thread and consumes any exceptions.
         * @hide
         */
        private final void onConnectedWrapped(
                @Nullable final TrustedWebActivityServiceWrapper service) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Log.w(TAG, "Exception while trying to use TrustedWebActivityService", ex);
                    }
                }
            });
        }
    ...
    private class Connection implements ServiceConnection {
        ...
        private List<ExecutionCallback> mCallbacks = new LinkedList<>();
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            for (ExecutionCallback callback : mCallbacks) {
                callback.onConnectedWrapped(mService);
            }
            mCallbacks.clear();
        }
        ...
        public void addCallback(ExecutionCallback callback) {
            if (mService == null) {
    ...
    private static Set<String> getVerifiedPackages(Context context, String origin) {
        ...
        try {
            ...
            Set<String> packages = origin == null ? null :
                    sSharedPreferences.get().getStringSet(origin, new HashSet<String>());
        ...
        new AsyncTask<Void, Void, Connection>() {
            ...
            protected void onPostExecute(Connection newConnection) {
                if (newConnection == null) {
                    callback.onConnectedWrapped(null);
                } else {

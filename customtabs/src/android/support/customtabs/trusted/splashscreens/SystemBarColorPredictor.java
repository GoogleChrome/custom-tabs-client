 ...
 * Activity based on an instance of {@link TrustedWebActivityBuilder}.
 */
class SystemBarColorPredictor {

    private static final int CHROME_VERSION_SUPPORTING_COLOR_SCHEMES = 380900000;
    ...
    Integer getExpectedStatusBarColor(Context context, String providerPackage,
        ...
        return builder.getToolbarColor();
    }
    ...
    private boolean providerSupportsColorSchemeParams(Context context, String providerPackage) {
        if (TrustedWebUtils.SUPPORTED_CHROME_PACKAGES.contains(providerPackage) &&
            getVersion(context, providerPackage) >= CHROME_VERSION_SUPPORTING_COLOR_SCHEMES) {
            // Chrome 76 doesn't have the category, but supports color schemes. Remove this code
            // after a while.
            return true;
        }

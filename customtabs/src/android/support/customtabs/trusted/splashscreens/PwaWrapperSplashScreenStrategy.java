...
public class PwaWrapperSplashScreenStrategy implements SplashScreenStrategy {
    ...
    @Override
    public void onTwaLaunchInitiated(String providerPackage, @ColorInt int statusBarColor) {
     ...
     */
    private void customizeStatusAndNavBarDuringSplashScreen(@ColorInt int statusBarColor) {

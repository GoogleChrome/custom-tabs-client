...
public class LauncherActivityTest {
    ...
    public void sendsShareTargetWithSendIntent() {
        ...
        // Comparing just the action to the one R.string.share_target to make sure the ShareTarget
        // has reached the TWA. Unit tests for the json parsing are elsewhere.

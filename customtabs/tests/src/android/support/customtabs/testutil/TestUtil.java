...
package android.support.customtabs.testutil;
...
public class TestUtil {
    ...
    public static TestBrowser getBrowserActivityWhenLaunched(Runnable launchRunnable) {
        ...
        TestBrowser activity =
                (TestBrowser) instrumentation.waitForMonitorWithTimeout(monitor, 30000);
     ...
     */
    public static void runOnUiThreadBlocking(Runnable c) {

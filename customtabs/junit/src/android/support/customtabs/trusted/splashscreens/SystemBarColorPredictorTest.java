...
public class SystemBarColorPredictorTest {
    ...
    private final TrustedWebActivityBuilder mBuilder = new TrustedWebActivityBuilder(mContext,
            Uri.parse(""));
    ...
    private void assertStatusBarColor(int color) {
        assertEquals((Integer) color, mPredictor.getExpectedStatusBarColor(mContext, PACKAGE,
                mBuilder));
    }

    private void assertNavBarColor(int color) {
        assertEquals((Integer) color, mPredictor.getExpectedNavbarColor(mContext, PACKAGE,
                mBuilder));
    }

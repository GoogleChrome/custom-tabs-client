...
public class CustomTabActivityHelper implements ServiceConnectionCallback {
    ...
    public static void openCustomTab(Activity activity,
        ...
        // com.chrome.canary
        String packageName = "com.chrome.dev";//CustomTabsHelper.getPackageNameToUse(activity);
     ...
     * @param packageName the package name to connect the service to.
     */
    public void bindCustomTabsService(Activity activity, String packageName) {
    ...
    public void bindCustomTabsService(Activity activity) {
        bindCustomTabsService(activity, CustomTabsHelper.getPackageNameToUse(activity));
    }

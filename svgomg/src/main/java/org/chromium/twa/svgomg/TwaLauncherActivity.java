...
public class TwaLauncherActivity extends AppCompatActivity
    ...
    private TwaSessionHelper mTwaSessionHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTwaSessionHelper = TwaSessionHelper.getInstance();
        mTwaSessionHelper.setTwaSessionCallback(this);
        mTwaSessionHelper.bindService(this, originUri);
    }

    public void openTwa() {
        // Set an empty transition from TwaLauncherActivity to the TWA splash screen.
        CustomTabsIntent customTabsIntent = mTwaSessionHelper.createIntentBuilder()
                .setStartAnimations(this, 0, 0)
                .build();

        Uri openUri = Uri.parse(TARGET_URL);
        mTwaSessionHelper.openTwa(this, customTabsIntent, openUri);
    }
